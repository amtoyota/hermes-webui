...
def _security_headers(handler):
    ...
    handler.send_header(
        ...
        "img-src 'self' data: https: blob:; media-src 'self' data: blob:; font-src 'self' data: https://cdn.jsdelivr.net https://fonts.gstatic.com; connect-src 'self' https://cdn.jsdelivr.net; "
